import { View,ViewStyle, Text, Image, StyleSheet, Pressable, ImageSourcePropType } from 'react-native';
    ...
    <View style={styles.user_informationContainer}>
      ...
      <View style={styles.user_informationDisplay}>
        <View style={styles.user_informationDisplayLeftPart}>
          <Image source={icon} style={styles.infoImage} />
          <Text style={[styles.user_Text, styles.user_informationDisplayText]}>{displayText}</Text>
        </View>
        <Pressable onPress={() => editInfo()}>
          <Image source={require('../assets/icons/edit.png')} style={styles.infoImage} />
        </Pressable>
      </View>
    </View>
  );
  ...
  return (
    <View style={styles.user_informationContainer}>
      ...
      <View style={styles.user_informationDisplayWeek}>
          ...
          {displayText.map((item, index) => (
            <>
              <Text
                style={
                  dayBool[index]
                    ? [styles.bold, styles.user_Text]
                    : [styles.user_weekText, styles.mediumbold]
                }
                key={index}
              >
                {item}
              ...
              <Text
                style={[styles.user_weekText, styles.mediumbold]}
                key={index + 'a'}
              >
        ...
        <Pressable style={styles.editButton} onPress={() => editInfo()}>
          <Image
